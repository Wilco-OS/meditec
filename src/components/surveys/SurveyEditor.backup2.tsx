...
export default function SurveyEditor({
  ...
  const [survey, setSurvey] = useState<Survey>(() => {
    ...
    if (
      ...
      console.log(
        "Keine Fragen auf oberster Ebene gefunden, extrahiere aus Blöcken...",
      );

      // Fragen aus den Blöcken sammeln
      extractedQuestions = [];
      initialData.blocks.forEach(
        (block: { id: string; title: string; questions?: any[] }) => {
          if (block.questions && Array.isArray(block.questions)) {
            console.log(
              `Block '${block.title}' enthält ${block.questions.length} Fragen`,
            );
      ...
      console.log(
        `Insgesamt ${extractedQuestions.length} Fragen aus Blöcken extrahiert`,
      );
    }
  ...
  const [assignedCompanyId, setAssignedCompanyId] = useState<string>(() => {
    // Debugging
    console.log(
      "AssignedCompanies aus initialData:",
  ...
  const saveSurvey = async () => {
    ...
    try {
      ...
      survey.blocks.forEach(
        (
          ...
          block.questions.forEach((question, qIndex) => {
            console.log(
              `  Frage ${qIndex + 1}: ${question.text || "Keine Textangabe"}`,
            );
      ...
      survey.blocks = survey.blocks.map(
        (block: {
          id: string;
          title?: string;
          description?: string;
      ...
      const surveyToSave = {
        ...survey,
        assignedCompanies:
          assignedCompanyId && assignedCompanyId !== "none"
            ? [assignedCompanyId]
            : [],
      };

      console.log(
        "Zu speichernde Umfrage mit Unternehmenszuweisung:",
        surveyToSave.assignedCompanies,
      );
      ...
      if (!response.ok) {
        ...
        throw new Error(
          `Fehler beim Speichern der Umfrage (${response.status}): ${errorText || response.statusText}`,
        );
      }
  ...
  const deleteBlock = (blockIndex: number) => {
    ...
    // Update Block-Liste
    const updatedBlocks = survey.blocks.filter(
  ...
  const saveQuestion = () => {
    ...
    if (
      ...
      toast({
        title: "Fehler",
        description:
          "Multiple-Choice-Fragen benötigen mindestens zwei Optionen.",
        variant: "destructive",
      });
      return;
    }
  ...
  const removeOption = (optionId: string) => {
    ...
    setEditingQuestion((prev: SurveyQuestion) => ({
      ...
      options: (prev.options || []).filter(
        (opt: SurveyOption) => opt.id !== optionId,
      ),
    }));
  };
        ...
        <TabsContent value="edit" className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateSurveyGeneral("description", e.target.value)
                  }
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateSurveyGeneral("isAnonymous", checked)
                  }
                />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Card className="md:col-span-3">
              <CardHeader>
                <CardTitle>
                  {survey.blocks[selectedBlockIndex]?.title ||
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateBlock(selectedBlockIndex, "title", e.target.value)
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="blockDescription"
                      value={
                        survey.blocks[selectedBlockIndex]?.description || ""
                      }
                      onChange={(e) =>
                        updateBlock(
                          selectedBlockIndex,
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="blockRestrictToDepartments">
                        Abteilungsspezifischer Abschnitt
                      </Label>
                      <Switch
                        ...
                        <div className="mt-2 space-y-2">
                          ...
                          {companies.length === 0 && (
                            <p className="text-sm text-muted-foreground">
                              Keine Unternehmen mit Abteilungen verfügbar
                            </p>
                          )}
                        </div>
                        <p className="text-xs text-muted-foreground mt-2">
                          Hinweis: Dieser Abschnitt wird nur Mitarbeitern
                          angezeigt, die den ausgewählten Abteilungen angehören.
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  {currentBlockQuestions.length > 0 ? (
                    ...
                    <div className="text-center py-8 border rounded-lg bg-gray-50">
                      <p className="text-muted-foreground">
                        Keine Fragen in diesem Abschnitt. Fügen Sie Fragen
            ...
            >
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Legen Sie den Zeitraum fest, in dem die Umfrage aktiv sein
                    soll.
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4 py-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <DatePicker
                      date={
                        survey.endDate ? new Date(survey.endDate) : undefined
                      }
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem key="text" value={QuestionType.TEXT}>
                      Freitext
                    </SelectItem>
                    <SelectItem key="yes_no" value={QuestionType.YES_NO}>
                      Ja/Nein
                    </SelectItem>
                    <SelectItem
                      key="agree_disagree"
                      value={QuestionType.AGREE_DISAGREE}
                    >
                      Zustimmung
                    </SelectItem>
                    <SelectItem
                    ...
                    <SelectItem key="rating" value={QuestionType.RATING}>
                      Bewertung (1-5)
                    </SelectItem>
                  </SelectContent>
                </Select>
